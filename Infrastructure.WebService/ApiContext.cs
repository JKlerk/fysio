...
namespace Infrastructure.WebService
{
    public class ApiContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            using (var reader = new StreamReader("/home/vsts/work/1/s/Infrastructure.WebService/Files/Vektis_diagnose.csv"))
            ...
            using (var reader = new StreamReader("/home/vsts/work/1/s/Infrastructure.WebService/Files/Vektis_treatment.csv"))
            using (var csv = new CsvReader(reader, CultureInfo.InvariantCulture))
            {
                csv.Read();
                csv.ReadHeader();
